...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative mx-auto mt-9 mb-0 w-full  max-md:px-5 max-md:py-0 2xl:mt-22">
      <h1 className="mx-auto mt-0 mb-11 w-full text-3xl 2xl:text-5xl font-bold tracking-wide text-center text-white leading-12 2xl:leading-[72px] max-w-[1028px] max-md:mb-8 max-md:text-4xl max-md:leading-[54px] max-sm:mb-6 max-sm:text-3xl max-sm:leading-10">
      ...
      <div className="flex justify-center mb-7 2xl:mb-8">
        <h2 className="text-xl 2xl:text-[28px] font-bold text-[#7FE4FF]">
          {t("hero.joinCall")}
        </h2>
      </div>
