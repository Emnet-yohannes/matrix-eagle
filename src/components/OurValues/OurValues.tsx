...
export default function Component() {
  ...
  return (
    <div className="bg-black/26 pb-4 2xl:py-16 md:py-8 px-4 pt-[120px] 3xl:pt-[290px] 3xl:pb-[50px]  md:px-10 2xl:px-[130px]">
      <div className="max-w-7xl 2xl:max-w-[100%] mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 2xl:gap-x-4 3xl:gap-x-[91px]">
          {values.map((value, index) => {
            return (
              <div className="relative p-3 2xl:p-0 2xl:w-[300px] 2xl:h-[220px] 3xl:w-[550px] 3xl:h-[252px]">
                ...
                <div
                  key={index}
                  className="bg-linear-to-r from-[#737373]/38 to-black/38 border 3xl:border-4 border-[#00D962] rounded-2xl p-2 lg:p-4 2xl:p-8 h-full 2xl:min-h-[220px] flex flex-col justify-between"
                >
                  <div className="mt-1 2xl:mt-0">
                    <h2 className="text-xl lg:text-2xl 2xl:text-[34px] 3xl:text-[55px] font-bold text-[#FFEB31] mb-1 2xl:mb-4">
                      {value.title}
                    </h2>
