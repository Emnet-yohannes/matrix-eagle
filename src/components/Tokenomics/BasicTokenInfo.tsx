...
export const BasicTokenInfo: React.FC<BasicTokenInfoProps> = ({
  ...
  return (
    <section className="mt-8 2xl:mt-28 py-3 w-full border border-orange-300 border-solid rounded-[29px] max-md:mt-10 max-md:max-w-full">
      <div className="flex gap-x-5 max-md:flex-col  ">
        <div className="w-[68%] max-md:ml-0 max-md:w-full">
          <div className="md:py-3 max-md:flex-col flex items-center flex-wrap grow text-xs sm:text-sm 2xl:text-3xl font-bold tracking-wide text-center text-white  max-md:max-w-full">
            <div className=" flex  h-full items-center  md:border-r-[4px] border-r-[#F6B387] grow shrink-0 px-16 basis-0 w-fit max-md:px-5 max-md:max-w-full">
              Name: {name}
            </div>
            <div className="md:border-r-[4px] border-r-[#F6B387] grow shrink-0 px-16  basis-0 w-fit max-md:px-5">
              Symbol: {symbol}
            </div>
          </div>
        </div>
