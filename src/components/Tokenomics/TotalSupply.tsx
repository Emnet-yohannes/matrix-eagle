...
export const TotalSupply: React.FC<TotalSupplyProps> = ({
  ...
  return (
    <header className="mt-[76px] flex flex-col self-stretch w-full text-xs sm:text-sm 2xl:text-3xl font-semibold max-md:max-w-full">
      <h1 className="self-center text-white max-md:max-w-full">
        <span className="text-white">Total Supply:</span>{" "}
        <span className="text-xs sm:text-sm 2xl:text-3xl text-[#FFA100]">{totalSupply}</span>
      </h1>
