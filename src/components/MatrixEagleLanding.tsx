...
export const MatrixEagleLanding: React.FC = () => {
  return (
    <div className="w-full 2xl:pr-[50px]">
        ...
        <div className="flex items-center justify-center w-full">
          <div className="w-full">
            <div className="flex flex-col lg:flex-row lg:gap-x-4 lg:justify-between px-0 lg:px-10 2xl:px-0 ">
              <div className="w-[100%] lg:w-[50%] xl:w-[45%] 2xl:w-[50%]  2xl:mt-[180px] 2xl:pl-[100px]  3xl:pl-[130px]">
                <HeroSection />
              </div>
              <div className="w-full lg:w-[36%] xl:w-[55%] 2xl:w-[50%] ">
      ...
      <div className="px-0 lg:px-10 pt-[20px] lg:pt-[80px] 2xl:pl-[60px] 3xl:px-[130px] 2xl:pt-[20px]">
        <TrustedParteners />
      </div>
