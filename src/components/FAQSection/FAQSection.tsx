  ...
  return (
    <section className="relative w-full mt-[82px] ">
      <div className="flex relative flex-col gap-10 items-center px-6 pt-0 pb-20 mx-auto my-0 max-w-full w-[1200px] max-md:px-5 max-md:pt-0 max-md:pb-16 max-sm:px-4 max-sm:pt-0 max-sm:pb-10">
        <header className="mb-10 h-12 text-lg 2xl:text-3xl font-bold tracking-wide leading-10 text-center text-white w-[110px] max-md:text-3xl max-sm:mb-5 max-sm:h-auto max-sm:text-2xl">
          <h2>FAQs</h2>
        </header>
